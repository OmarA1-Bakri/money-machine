...
- Refreshed `head_sha`, `evidence_closure_commit_sha`, and `last_verified_commit` to `9b791d45f9461030f09eda8a46838afc5447416c` (L4 squash tip on `build/full-automation`). State revision 29 → 30.
