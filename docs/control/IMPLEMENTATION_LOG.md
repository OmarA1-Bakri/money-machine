...
- **Test results**: CI on the PR tip: 1043 passed, 1 skipped. Local: browser adapter 37 functions / 60 collected, router 11 functions / 11 collected (9 existing + 2 new), all pass. Zero orchestration/ diffs, api_adapter.py untouched, fixture adapter default preserved.
