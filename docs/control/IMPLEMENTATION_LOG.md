...
- **Pytest collected**: 1256 collected, 1255 passed, 1 skipped. W4b baseline: 1088 collected, 1087 passed, 1 skipped. Delta +168 collected and +168 passed.
- **Per-file counts**:
  ...
  | `tests/unit/observability/test_receipts.py` | 0 → 45 | 0 → 53 | +53 |
  | Remaining files | unchanged | 986 → 986 | 0 |
  | **Total** | | **1088 → 1256** | **+168** |

- **Mutation checks** (79 rows; each applied, pytest run, then reverted):
