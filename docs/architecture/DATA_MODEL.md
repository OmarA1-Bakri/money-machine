...
**Contract status:** logical Session 01 model for the PostgreSQL schema designed in Session 02. Names are canonical; this document does not claim that tables already exist.

## Identity and time conventions

- Primary identifiers are UUIDs generated by the application.
