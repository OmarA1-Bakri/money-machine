...
| Workbook page | PDF page | Structured record | Future durable job / owner | Manual handoff / automation gap | Target session |
|---|---|---|---|---|---|
| 1 | 77 | Niche shortlist grid | ResearchObservation[] | ResearchCollectionJob / research agent | Manual marketplace observation when no admitted adapter exists. | 05 |
| 2 | 78 | Low-Ticket filter scorecard | QualificationScore[] | QualificationJob / research agent | Candidate evidence and four scores must be complete; reject under 30/40. | 05 |
